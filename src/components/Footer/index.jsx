    ...
    <div>
      <footer className="footer footer-bg footer-text py-6 w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-screen-xl mx-auto px-4">
          <div>
            <h4 className="font-bold mb-2">不要B我市集</h4>
              <p className="text-xs sm:text-sm m-0">數位二甲 111219036 施亞蝶<br></br>數位二甲 111219035 劉恩伶<br></br>113學年第二學期<br></br>跨平台前端工程設計 期末專題</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">攤位相關</h4>
              <p className="text-xs sm:text-sm m-0">報名方式<br></br>注意事項<br></br>收費制度<br></br>攤位地圖</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">常見問題</h4>
              <p className="text-xs sm:text-sm m-0">訊息公告<br></br>退貨政策<br></br>訂單查詢<br></br>服務條款</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">聯絡資訊</h4>
            ...
            <h4 className="font-bold mb-2">社群媒體</h4>
